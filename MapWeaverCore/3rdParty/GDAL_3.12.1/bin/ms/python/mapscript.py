...
class resultCacheObj(object):
    ...
    hasnext = property(_mapscript.resultCacheObj_hasnext_get)
...
class layerObj(object):
    ...
    identificationclassauto = property(_mapscript.layerObj_identificationclassauto_get, _mapscript.layerObj_identificationclassauto_set)
    identificationclassgroup = property(_mapscript.layerObj_identificationclassgroup_get, _mapscript.layerObj_identificationclassgroup_set)
...
def msConfigGetMap(config, key, pszReturnPath):
